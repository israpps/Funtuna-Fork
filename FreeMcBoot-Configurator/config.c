		...
		if (readpad()) {
			if (new_pad & PAD_UP) {
				...
				if (s == 1) {
					...
					else if (!strcmp(fmcb->OSD_E2_Path[item], "FASTBOOT"))
						sprintf(fmcb->OSD_E2_Path[item], "OSDMENU");
					else if (!strcmp(fmcb->OSD_E2_Path[item], "OSDMENU"))
						sprintf(fmcb->OSD_E2_Path[item], "POWEROFF");
					else
						sprintf(fmcb->OSD_E2_Path[item], "OSDSYS");
				} else if (s == 3) {
					if (!strcmp(fmcb->OSD_E3_Path[item], "OSDSYS"))
						sprintf(fmcb->OSD_E3_Path[item], "FASTBOOT");
					else if (!strcmp(fmcb->OSD_E3_Path[item], "FASTBOOT"))
						sprintf(fmcb->OSD_E3_Path[item], "OSDMENU");
					else if (!strcmp(fmcb->OSD_E3_Path[item], "OSDMENU"))
						sprintf(fmcb->OSD_E3_Path[item], "POWEROFF");
					else
